  ...
  const recipes = {
    ...
    Recasting: [
      ...
      [
        ...
        {name: 'upgrade_impure_bronze_cuirass', recipe: [['flux', [0, 2, 6, 8], 'bronze alloy mix', [3, 5], 'impure bronze cuirass', [4]]], result: 'bronze cuirass'},
        {name: 'upgrade_bronze_claymore', recipe: ['flux', [0, 2, 6, 8], 'iron bar', [3, 5, 7], 'bronze claymore', [4]], result: 'iron claymore'},
        {name: 'upgrade_bronze_cuirass', recipe: [['flux', [0, 2, 6, 8], 'iron bar', [3, 5, 7], 'bronze cuirass', [4]]], result: 'iron cuirass'},
        {name: 'upgrade_iron_claymore', recipe: ['flux', [0, 2, 6, 8], 'lump of coal', [3, 5, 7], 'iron claymore', [4]], result: 'steel claymore'},
        {name: 'upgrade_iron_cuirass', recipe: [['flux', [0, 2, 6, 8], 'lump of coal', [3, 5, 7], 'iron cuirass', [4]]], result: 'steel cuirass'},
      ],
      [
        {name: 'upgrade_steel_claymore', recipe: ['flux', [0, 2, 6, 8], 'gold bar', [3, 5, 7], 'steel claymore', [4]], result: 'gold claymore'},
        {name: 'upgrade_steel_cuirass', recipe: [['flux', [0, 2, 6, 8], 'gold bar', [3, 5, 7], 'steel cuirass', [4]]], result: 'gold cuirass'},
        {name: 'upgrade_gold_claymore', recipe: ['flux', [0, 2, 6, 8], 'mithril bar', [1, 3, 5, 7], 'gold claymore', [4]], result: 'mithril claymore'},
        {name: 'upgrade_gold_cuirass', recipe: [['flux', [0, 2, 6, 8], 'mithril bar', [1, 3, 5, 7], 'gold cuirass', [4]]], result: 'mithril cuirass'},
        {name: 'upgrade_mithril_claymore', recipe: ['flux', [0, 2, 6, 8], 'adamantium bar', [1, 3, 5, 7], 'mithril claymore', [4]], result: 'adamantium claymore'},
        {name: 'upgrade_mithril_cuirass', recipe: [['flux', [0, 2, 6, 8], 'adamantium bar', [1, 3, 5, 7], 'mithril cuirass', [4]]], result: 'adamantium cuirass'},
      ],
      [
        {name: 'upgrade_quartz_khopesh', recipe: ['flux', [0, 2, 6, 8], 'jade bar', [3, 5, 7], 'quartz khopesh', [4]], result: 'jade khopesh'},
        {name: 'upgrade_quartz_chainmail', recipe: [['flux', [0, 2, 6, 8], 'jade bar', [3, 5, 7], 'quartz chainmail', [4]]], result: 'jade chainmail'},
        {name: 'upgrade_jade_khopesh', recipe: ['flux', [0, 2, 6, 8], 'amethyst bar', [1, 3, 5, 7], 'jade khopesh', [4]], result: 'amethyst khopesh'},
        {name: 'upgrade_jade_chainmail', recipe: [['flux', [0, 2, 6, 8], 'amethyst bar', [1, 3, 5, 7], 'jade chainmail', [4]]], result: 'amethyst chainmail'},
      ],
      // Downgrade
      [
        {name: 'downgrade_empowered_quartz_loop_of_aggression', recipe: ['flux', [1], 'empowered quartz loop of aggression', [4], 'tongs', [7]], result: 'quartz loop of aggression', warning: downgradeWarning},
        {name: 'downgrade_empowered_quartz_loop_of_fortune', recipe: ['flux', [1], 'empowered quartz loop of fortune', [4], 'tongs', [7]], result: 'quartz loop of fortune', warning: downgradeWarning},
        {name: 'downgrade_empowered_quartz_loop_of_luck', recipe: ['flux', [1], 'empowered quartz loop of luck', [4], 'tongs', [7]], result: 'quartz loop of luck', warning: downgradeWarning},
        {name: 'downgrade_empowered_jade_loop_of_aggression', recipe: ['flux', [1], 'empowered jade loop of aggression', [4], 'tongs', [7]], result: 'jade loop of aggression', warning: downgradeWarning},
        {name: 'downgrade_empowered_jade_loop_of_fortune', recipe: ['flux', [1], 'empowered jade loop of fortune', [4], 'tongs', [7]], result: 'jade loop of fortune', warning: downgradeWarning},
        {name: 'downgrade_empowered_jade_loop_of_luck', recipe: ['flux', [1], 'empowered jade loop of luck', [4], 'tongs', [7]], result: 'jade loop of luck', warning: downgradeWarning},
        {name: 'downgrade_empowered_amethyst_loop_of_aggression', recipe: ['flux', [1], 'empowered amethyst loop of aggression', [4], 'tongs', [7]], result: 'amethyst loop of aggression', warning: downgradeWarning},
        {name: 'downgrade_empowered_amethyst_loop_of_fortune', recipe: ['flux', [1], 'empowered amethyst loop of fortune', [4], 'tongs', [7]], result: 'amethyst loop of fortune', warning: downgradeWarning},
        {name: 'downgrade_empowered_amethyst_loop_of_luck', recipe: ['flux', [1], 'empowered amethyst loop of luck', [4], 'tongs', [7]], result: 'amethyst loop of luck', warning: downgradeWarning},
      ],
      [
        {name: 'downgrade_empowered_quartz_prism_of_aggression', recipe: ['flux', [1], 'empowered quartz prism of aggression', [4], 'tongs', [7]], result: 'quartz prism of aggression', warning: downgradeWarning},
        {name: 'downgrade_empowered_quartz_prism_of_fortune', recipe: ['flux', [1], 'empowered quartz prism of fortune', [4], 'tongs', [7]], result: 'quartz prism of fortune', warning: downgradeWarning},
        {name: 'downgrade_empowered_quartz_prism_of_luck', recipe: ['flux', [1], 'empowered quartz prism of luck', [4], 'tongs', [7]], result: 'quartz prism of luck', warning: downgradeWarning},
        {name: 'downgrade_empowered_jade_trifocal_of_aggression', recipe: ['flux', [1], 'empowered jade trifocal of aggression', [4], 'tongs', [7]], result: 'jade trifocal of aggression', warning: downgradeWarning},
        {name: 'downgrade_empowered_jade_trifocal_of_fortune', recipe: ['flux', [1], 'empowered jade trifocal of fortune', [4], 'tongs', [7]], result: 'jade trifocal of fortune', warning: downgradeWarning},
        {name: 'downgrade_empowered_jade_trifocal_of_luck', recipe: ['flux', [1], 'empowered jade trifocal of luck', [4], 'tongs', [7]], result: 'jade trifocal of luck', warning: downgradeWarning},
        {name: 'downgrade_empowered_amethyst_totality_of_aggression', recipe: ['flux', [1], 'empowered amethyst totality of aggression', [4], 'tongs', [7]], result: 'amethyst totality of aggression', warning: downgradeWarning},
        {name: 'downgrade_empowered_amethyst_totality_of_fortune', recipe: ['flux', [1], 'empowered amethyst totality of fortune', [4], 'tongs', [7]], result: 'amethyst totality of fortune', warning: downgradeWarning},
        {name: 'downgrade_empowered_amethyst_totality_of_luck', recipe: ['flux', [1], 'empowered amethyst totality of luck', [4], 'tongs', [7]], result: 'amethyst totality of luck', warning: downgradeWarning},
      ],
      [
        {name: 'downgrade_impure_bronze_cuirass', recipe: ['flux', [1], 'impure bronze cuirass', [4], 'tongs', [7]], result: 'impure bronze segmentata', warning: downgradeWarning},
        {name: 'downgrade_bronze_cuirass', recipe: ['flux', [1], 'bronze cuirass', [4], 'tongs', [7]], result: 'bronze segmentata', warning: downgradeWarning},
        {name: 'downgrade_iron_cuirass', recipe: ['flux', [1], 'iron cuirass', [4], 'tongs', [7]], result: 'iron segmentata', warning: downgradeWarning},
        {name: 'downgrade_steel_cuirass', recipe: ['flux', [1], 'steel cuirass', [4], 'tongs', [7]], result: 'steel segmentata', warning: downgradeWarning},
        {name: 'downgrade_gold_cuirass', recipe: ['flux', [1], 'gold cuirass', [4], 'tongs', [7]], result: 'gold segmentata', warning: downgradeWarning},
        {name: 'downgrade_mythril_cuirass', recipe: ['flux', [1], 'mythril cuirass', [4], 'tongs', [7]], result: 'mythril segmentata', warning: downgradeWarning},
        {name: 'downgrade_adamantium_cuirass', recipe: ['flux', [1], 'adamantium cuirass', [4], 'tongs', [7]], result: 'adamantium segmentata', warning: downgradeWarning},
      ],
      [
        {name: 'downgrade_impure_bronze_claymore', recipe: ['flux', [1], 'impure bronze claymore', [4], 'tongs', [7]], result: 'impure bronze billhook', warning: downgradeWarning},
        {name: 'downgrade_bronze_claymore', recipe: ['flux', [1], 'bronze claymore', [4], 'tongs', [7]], result: 'bronze billhook', warning: downgradeWarning},
        {name: 'downgrade_iron_claymore', recipe: ['flux', [1], 'iron claymore', [4], 'tongs', [7]], result: 'iron billhook', warning: downgradeWarning},
        {name: 'downgrade_steel_claymore', recipe: ['flux', [1], 'steel claymore', [4], 'tongs', [7]], result: 'steel billhook', warning: downgradeWarning},
        {name: 'downgrade_gold_claymore', recipe: ['flux', [1], 'gold claymore', [4], 'tongs', [7]], result: 'gold billhook', warning: downgradeWarning},
        {name: 'downgrade_mythril_claymore', recipe: ['flux', [1], 'mythril claymore', [4], 'tongs', [7]], result: 'mythril billhook', warning: downgradeWarning},
        {name: 'downgrade_adamantium_claymore', recipe: ['flux', [1], 'adamantium claymore', [4], 'tongs', [7]], result: 'adamantium billhook', warning: downgradeWarning},
      ],
      [
        {name: 'downgrade_quartz_chainmail', recipe: ['flux', [1], 'quartz chainmail', [4], 'tongs', [7]], result: 'quartz lamellar', warning: downgradeWarning},
        {name: 'downgrade_jade_chainmail', recipe: ['flux', [1], 'jade chainmail', [4], 'tongs', [7]], result: 'jade lamellar', warning: downgradeWarning},
        {name: 'downgrade_amethyst_chainmail', recipe: ['flux', [1], 'amethyst chainmail', [4], 'tongs', [7]], result: 'amethyst lamellar', warning: downgradeWarning},
        {name: 'downgrade_quartz_khopesh', recipe: ['flux', [1], 'quartz khopesh', [4], 'tongs', [7]], result: 'quartz guandao', warning: downgradeWarning},
        {name: 'downgrade_jade_khopesh', recipe: ['flux', [1], 'jade khopesh', [4], 'tongs', [7]], result: 'jade guandao', warning: downgradeWarning},
    ...
    Jewelry: [
      ...
      [
        {name: 'quartz_prism_of_aggression', recipe: ['emerald chip', [0, 2, 3, 5, 6, 8], 'quartz bar', [1], 'impure bronze bar', [7], 'carbon-crystalline quartz necklace', [4]]},
        {name: 'quartz_prism_of_fortune', recipe: ['ruby chip', [0, 2, 3, 5, 6, 8], 'quartz bar', [1], 'impure bronze bar', [7], 'carbon-crystalline quartz necklace', [4]]},
        {name: 'quartz_prism_of_luck', recipe: ['sapphire chip', [0, 2, 3, 5, 6, 8], 'quartz bar', [1], 'impure bronze bar', [7], 'carbon-crystalline quartz necklace', [4]]},
        {name: 'quartz_loop_of_aggression', recipe: ['emerald chip', [1], 'silver ring of gazellia', [4], 'quartz bar', [7]]},
        {name: 'quartz_loop_of_fortune', recipe: ['ruby chip', [1], 'silver ring of gazellia', [4], 'quartz bar', [7]]},
        {name: 'quartz_loop_of_luck', recipe: ['sapphire chip', [1], 'silver ring of gazellia', [4], 'quartz bar', [7]]},
      ],
      [
        {name: 'jade_trifocal_of_aggression', recipe: ['jade bar', [0, 1, 2], 'emerald', [3, 5], 'bronze bar', [7], 'carbon-crystalline quartz necklace'[4]]},
        {name: 'jade_trifocal_of_fortune', recipe: ['jade bar', [0, 1, 2], 'ruby', [3, 5], 'bronze bar', [7], 'carbon-crystalline quartz necklace'[4]]},
        {name: 'jade_trifocal_of_luck', recipe: ['jade bar', [0, 1, 2], 'sapphire', [3, 5], 'bronze bar', [7], 'carbon-crystalline quartz necklace'[4]]},
        {name: 'jade_loop_of_aggression', recipe: ['emerald', [1], 'silver ring of gazellia', [4], 'jade bar', [3, 5]]},
        {name: 'jade_loop_of_fortune', recipe: ['ruby', [1], 'silver ring of gazellia', [4], 'jade bar', [3, 5]]},
        {name: 'jade_loop_of_luck', recipe: ['sapphire', [1], 'silver ring of gazellia', [4], 'jade bar', [3, 5]]},
      ],
      [
        {name: 'amethyst_totality_of_aggression', recipe: ['amethyst bar', [0, 1, 2], 'emerald', [3, 5], 'gold bar', [7], 'carbon-crystalline quartz necklace', [4], 'exquisite constellation of emeralds', [6]]},
        {name: 'amethyst_totality_of_aggression', recipe: ['amethyst bar', [0, 1, 2], 'emerald', [3, 5], 'gold bar', [7], 'carbon-crystalline quartz necklace', [4], 'exquisite constellation of emeralds', [6]]},
        {name: 'amethyst_totality_of_aggression', recipe: ['amethyst bar', [0, 1, 2], 'emerald', [3, 5], 'gold bar', [7], 'carbon-crystalline quartz necklace', [4], 'exquisite constellation of emeralds', [6]]},
        {name: 'amethyst_loop_of_aggression', recipe: ['emerald', [0, 1, 2], 'silver ring of gazellia', [4], 'amethyst bar', [3, 5, 7]]},
        {name: 'amethyst_loop_of_fortune', recipe: ['ruby', [0, 1, 2], 'silver ring of gazellia', [4], 'amethyst bar', [3, 5, 7]]},
        {name: 'amethyst_loop_of_luck', recipe: ['sapphire', [0, 1, 2], 'silver ring of gazellia', [4], 'amethyst bar', [3, 5, 7]]},
      ],
      [
        ...
        {name: 'empowered_amethyst_loop_of_aggression', recipe: ['amethyst loop of aggression', [4], 'amethyst bar', [1, 5, 7]]},
        {name: 'empowered_amethyst_loop_of_fortune', recipe: ['amethyst loop of fortune', [4], 'amethyst bar', [1, 5, 7]]},
        {name: 'empowered_amethyst_loop_of_luck', recipe: ['amethyst loop of luck', [4], 'amethyst bar', [1, 5, 7]]},
      ],
      [
        {name: 'empowered_quartz_prism_of_aggression', recipe: ['quartz prism of aggression', [4], 'quartz bar', [3, 5]]},
        ...
        {name: 'empowered_jade_trifocal_of_aggression', recipe: ['jade trifocal of aggression', [4], 'jade bar', [1, 3, 5]]},
        ...
        {name: 'empowered_amethyst_totality_of_aggression', recipe: ['amethyst totality of aggression', [4], 'amethyst bar', [0, 1, 2, 3, 5]]},
        {name: 'empowered_amethyst_totality_of_fortune', recipe: ['amethyst totality of fortune', [4], 'amethyst bar', [0, 1, 2, 3, 5]]},
        {name: 'empowered_amethyst_totality_of_luck', recipe: ['amethyst totality of luck', [4], 'amethyst bar', [0, 1, 2, 3, 5]]},
      ],
    ],
    Trading_Decks: [
      [
    ...
    Valentines: [
      ...
      [
        ...
        {name: 'cupids_winged_boots_of_aggression', recipe: ['emerald chip', [1], 'cupids winged boots', [4], 'cupids magical feather', [7]]},
        {name: 'cupids_winged_boots_of_fortune', recipe: ['ruby chip', [1], 'cupids winged boots', [4], 'cupids magical feather', [7]]},
        {name: 'cupids_winged_boots_of_luck', recipe: ['sapphire chip', [1], 'cupids winged boots', [4], 'cupids magical feather', [7]]},
      ],
      [
        {name: 'downgrade_cupids_winged_boots_of_aggression', recipe: ['flux', [1, 3, 5, 7], 'cupids winged boots of aggression', [4]], result: 'cupids winged boots', warning: downgradeWarning},
        {name: 'downgrade_cupids_winged_boots_of_fortune', recipe: ['flux', [1, 3, 5, 7], 'cupids winged boots of fortune', [4]], result: 'cupids winged boots', warning: downgradeWarning},
        {name: 'downgrade_cupids_winged_boots_of_luck', recipe: ['flux', [1, 3, 5, 7], 'cupids winged boots of luck', [4]], result: 'cupids winged boots', warning: downgradeWarning},
      ],
      // Cupid's Wings
      [
        {name: 'cupids_gold_wings', recipe: [['sapphire', [0, 2], 'gold bar', [6, 8], 'cupids wings', [4]]]},
        {name: 'cupids_mythril_wings', recipe: [['sapphire', [0, 1, 2], 'mythril bar', [6, 7, 8], 'cupids wings', [4]]]},
        {name: 'cupids_adamantium_wings', recipe: [['sapphire', [0, 1, 2, 3], 'adamantium bar', [5, 6, 7, 8], 'cupids wings', [4]]]},
        {name: 'repair_cupids_wings', recipe: [['sapphire', [1], 'gold bar', [6, 8], 'cupids wings', [4]]], result: 'cupids wings'},
        {name: 'repair_cupids_gold_wings', recipe: [['sapphire', [1], 'gold bar', [7], 'cupids gold wings', [4]]], result: 'cupids gold wings'},
        {name: 'repair_cupids_mythril_wings', recipe: [['sapphire', [0, 2], 'mythril bar', [7], 'cupids mythril wings', [4]]], result: 'cupids mythril wings'},
        {name: 'repair_cupids_adamantium_wings', recipe: [['sapphire', [0, 1, 2], 'adamantium bar', [7], 'cupids adamantium wings', [4]]], result: 'cupids adamantium wings'},
      ],
      [
        ...
        {name: 'disassembled_cupids_adamantium_wings', recipe: ['flux', [0, 1, 2], 'tongs', [6, 7, 8], 'cupids adamantium wings']},
        {name: 'cupids_cradle', recipe: ['gods cradle', [4], 'cupids tiara', [5]]},
        {name: 'disassembled_cupids_cradle', recipe: ['flux', [0, 1, 2, 3], 'tongs', [5, 6, 7, 8], 'cupids cradle', [4]]},
      ],
    ],
    Halloween: [
      [
