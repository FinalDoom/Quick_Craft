...
(function (React, require$$0) {
  ...
  ***************************************************************************** */
  ...
  class GazelleApi {
      ...
      async getInventoryCounts() {
          return await this.call({ request: 'items', type: 'inventory' })
              ...
              return Object.fromEntries(Object.values(response.response)
      ...
      async getEquipmentInfo() {
          ...
          return await this.call({ request: 'items', type: 'users_equippable' })
              ...
              return response.response
                  ...
                  if (!(equip.itemId in grouped))
                      grouped[equip.itemId] = [];
  ...
  var _Observable_subscribers;
  class Observable {
      constructor() {
          _Observable_subscribers.set(this, new Set());
      }
      subscribe(observer) {
          __classPrivateFieldGet(this, _Observable_subscribers, "f").add(observer);
      }
      unsubscribe(observer) {
          __classPrivateFieldGet(this, _Observable_subscribers, "f").delete(observer);
      }
      notify(data) {
          for (const subscriber of __classPrivateFieldGet(this, _Observable_subscribers, "f")) {
              subscriber.notify(data);
          }
      }
  }
  _Observable_subscribers = new WeakMap();

  var _Inventory_api, _Inventory_inventory, _Inventory_equipment, _Inventory_inventoryObservable, _Inventory_equipmentObservable;
  class Inventory {
      constructor(api) {
          _Inventory_api.set(this, void 0);
          _Inventory_inventory.set(this, void 0);
          _Inventory_equipment.set(this, void 0);
          _Inventory_inventoryObservable.set(this, new Observable());
          _Inventory_equipmentObservable.set(this, new Observable());
          __classPrivateFieldSet(this, _Inventory_api, api, "f");
      }
      async refreshInventory() {
          const updatedInventory = (await __classPrivateFieldGet(this, _Inventory_api, "f").getInventoryCounts()) || {};
          const changed = __classPrivateFieldGet(this, _Inventory_inventory, "f") ? diff(__classPrivateFieldGet(this, _Inventory_inventory, "f"), updatedInventory) : updatedInventory;
          __classPrivateFieldSet(this, _Inventory_inventory, updatedInventory, "f");
          __classPrivateFieldGet(this, _Inventory_inventoryObservable, "f").notify(changed);
      }
      addOrSubtractItems(countChanges) {
          Object.entries(countChanges).forEach(([itemId, change]) => (countChanges[itemId] = __classPrivateFieldGet(this, _Inventory_inventory, "f")[itemId] += change));
          __classPrivateFieldGet(this, _Inventory_inventoryObservable, "f").notify(countChanges);
      }
      itemCount(itemId) {
          return __classPrivateFieldGet(this, _Inventory_inventory, "f")[itemId];
      }
      get inventoryObservable() {
          return __classPrivateFieldGet(this, _Inventory_inventoryObservable, "f");
      }
      async refreshEquipment() {
          const updatedEquipment = (await __classPrivateFieldGet(this, _Inventory_api, "f").getEquipmentInfo()) || {};
          const changed = __classPrivateFieldGet(this, _Inventory_equipment, "f") ? diff(__classPrivateFieldGet(this, _Inventory_equipment, "f"), updatedEquipment) : updatedEquipment;
          __classPrivateFieldSet(this, _Inventory_equipment, updatedEquipment, "f");
          __classPrivateFieldGet(this, _Inventory_equipmentObservable, "f").notify(changed);
      }
      get equipmentObservable() {
          return __classPrivateFieldGet(this, _Inventory_equipmentObservable, "f");
      }
  }
  _Inventory_api = new WeakMap(), _Inventory_inventory = new WeakMap(), _Inventory_equipment = new WeakMap(), _Inventory_inventoryObservable = new WeakMap(), _Inventory_equipmentObservable = new WeakMap();

  var _QuickCraftStore_instances, _QuickCraftStore_apiKey, _QuickCraftStore_currentCraft, _QuickCraftStore_repairEquipped, _QuickCraftStore_repairThreshold, _QuickCraftStore_selectedBooks, _QuickCraftStore_selectedCategories, _QuickCraftStore_selectedCraftable, _QuickCraftStore_selectedTypes, _QuickCraftStore_search, _QuickCraftStore_searchIngredients, _QuickCraftStore_sort, _QuickCraftStore_switchNeedHave, _QuickCraftStore_initGM, _QuickCraftStore_notifyStoreChanged, _QuickCraftStore_setGM, _QuickCraftStore_storageListener;
  var Sort;
  (function (Sort) {
  ...
  class QuickCraftStore {
      constructor() {
          _QuickCraftStore_instances.add(this);
          _QuickCraftStore_apiKey.set(this, void 0);
          _QuickCraftStore_currentCraft.set(this, void 0);
          _QuickCraftStore_repairEquipped.set(this, void 0);
          _QuickCraftStore_repairThreshold.set(this, void 0);
          _QuickCraftStore_selectedBooks.set(this, void 0);
          _QuickCraftStore_selectedCategories.set(this, void 0);
          _QuickCraftStore_selectedCraftable.set(this, void 0);
          _QuickCraftStore_selectedTypes.set(this, void 0);
          _QuickCraftStore_search.set(this, void 0);
          _QuickCraftStore_searchIngredients.set(this, void 0);
          _QuickCraftStore_sort.set(this, void 0);
          _QuickCraftStore_switchNeedHave.set(this, void 0);
      }
      async init() {
          __classPrivateFieldSet(this, _QuickCraftStore_apiKey, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'apiKey'), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_currentCraft, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'currentCraft', undefined), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_repairEquipped, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'repairEquipped', false), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_repairThreshold, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'repairThreshold', 0), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedBooks, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'selectedBooks', ['Potions', 'Food', 'Material Bars']), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedCategories, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'selectedCategories', CATEGORIES), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedCraftable, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'selectedCraftable', 0), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedTypes, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'selectedTypes', RECIPE_TYPES), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_search, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'search', undefined), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_searchIngredients, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'searchIngredients', true), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_sort, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'sort', 'book'), "f");
          __classPrivateFieldSet(this, _QuickCraftStore_switchNeedHave, await __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_initGM).call(this, 'switchNeedHave', false), "f");
          window.addEventListener('storage', __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_storageListener));
      }
      get apiKey() {
          return __classPrivateFieldGet(this, _QuickCraftStore_apiKey, "f");
      }
      set apiKey(key) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_apiKey, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_apiKey, key, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'apiKey', oldValue, key);
      }
      get currentCraft() {
          return __classPrivateFieldGet(this, _QuickCraftStore_currentCraft, "f");
      }
      set currentCraft(craft) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_currentCraft, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_currentCraft, craft, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'currentCraft', oldValue, craft);
      }
      get repairEquipped() {
          return __classPrivateFieldGet(this, _QuickCraftStore_repairEquipped, "f");
      }
      set repairEquipped(allowRepairEquipped) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_repairEquipped, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_repairEquipped, allowRepairEquipped, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'repairEquipped', oldValue, allowRepairEquipped);
      }
      get repairThreshold() {
          return __classPrivateFieldGet(this, _QuickCraftStore_repairThreshold, "f");
      }
      set repairThreshold(threshold) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_repairThreshold, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_repairThreshold, threshold, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'repairThreshold', oldValue, threshold);
      }
      get selectedBooks() {
          return __classPrivateFieldGet(this, _QuickCraftStore_selectedBooks, "f");
      }
      set selectedBooks(books) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_selectedBooks, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedBooks, books, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'selectedBooks', oldValue, books);
      }
      get selectedCategories() {
          return __classPrivateFieldGet(this, _QuickCraftStore_selectedCategories, "f");
      }
      set selectedCategories(categories) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_selectedCategories, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedCategories, categories, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'selectedCategories', oldValue, categories);
      }
      get selectedCraftable() {
          return __classPrivateFieldGet(this, _QuickCraftStore_selectedCraftable, "f");
      }
      set selectedCraftable(craftable) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_selectedCraftable, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedCraftable, craftable, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'selectedCraftable', oldValue, craftable);
      }
      get selectedTypes() {
          return __classPrivateFieldGet(this, _QuickCraftStore_selectedTypes, "f");
      }
      set selectedTypes(types) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_selectedTypes, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_selectedTypes, types, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'selectedTypes', oldValue, types);
      }
      get search() {
          return __classPrivateFieldGet(this, _QuickCraftStore_search, "f");
      }
      set search(search) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_search, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_search, search, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'search', oldValue, search);
      }
      get searchIngredients() {
          return __classPrivateFieldGet(this, _QuickCraftStore_searchIngredients, "f");
      }
      set searchIngredients(searchIngredients) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_searchIngredients, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_searchIngredients, searchIngredients, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'searchIngredients', oldValue, searchIngredients);
      }
      get sort() {
          return __classPrivateFieldGet(this, _QuickCraftStore_sort, "f");
      }
      set sort(sort) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_sort, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_sort, sort, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'sort', oldValue, sort);
      }
      get switchNeedHave() {
          return __classPrivateFieldGet(this, _QuickCraftStore_switchNeedHave, "f");
      }
      set switchNeedHave(isSwitched) {
          const oldValue = __classPrivateFieldGet(this, _QuickCraftStore_switchNeedHave, "f");
          __classPrivateFieldSet(this, _QuickCraftStore_switchNeedHave, isSwitched, "f");
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_setGM).call(this, 'switchNeedHave', oldValue, isSwitched);
      }
  }
  _QuickCraftStore_apiKey = new WeakMap(), _QuickCraftStore_currentCraft = new WeakMap(), _QuickCraftStore_repairEquipped = new WeakMap(), _QuickCraftStore_repairThreshold = new WeakMap(), _QuickCraftStore_selectedBooks = new WeakMap(), _QuickCraftStore_selectedCategories = new WeakMap(), _QuickCraftStore_selectedCraftable = new WeakMap(), _QuickCraftStore_selectedTypes = new WeakMap(), _QuickCraftStore_search = new WeakMap(), _QuickCraftStore_searchIngredients = new WeakMap(), _QuickCraftStore_sort = new WeakMap(), _QuickCraftStore_switchNeedHave = new WeakMap(), _QuickCraftStore_instances = new WeakSet(), _QuickCraftStore_initGM = async function _QuickCraftStore_initGM(name, defaultValue) {
  ...
  }, _QuickCraftStore_notifyStoreChanged = function _QuickCraftStore_notifyStoreChanged(name, oldValue, newValue) {
      window.dispatchEvent(new StorageEvent('storage', { key: name, newValue: JSON.stringify(newValue), oldValue: JSON.stringify(oldValue) }));
  }, _QuickCraftStore_setGM = async function _QuickCraftStore_setGM(name, oldValue, newValue) {
      if (oldValue !== newValue) {
          if (newValue !== undefined)
              await GM.setValue(GM_KEYS[name], newValue);
          else
              await GM.deleteValue(GM_KEYS[name]);
          __classPrivateFieldGet(this, _QuickCraftStore_instances, "m", _QuickCraftStore_notifyStoreChanged).call(this, name, oldValue, newValue);
      }
  }, _QuickCraftStore_storageListener = function _QuickCraftStore_storageListener(storageEvent) {
  ...
  var k = React__default["default"],
      l = require$$0__default["default"];
  ...
  var ReactTestUtils = /*@__PURE__*/getDefaultExportFromCjs(testUtils.exports);
  ...
  class BookButton extends React__default["default"].Component {
      ...
      render() {
          return (React__default["default"].createElement(Button, { additionalClassNames: this.base + '--book-' + this.props.book.toLocaleLowerCase().replace(/ /g, '-'), classNameBase: this.base, clickCallback: this.props.clickCallback, defaultSelected: this.props.defaultSelected, text: this.props.book, variant: "toggle" }));
      }
  }
  ...
  class Checkbox extends React__default["default"].Component {
      ...
      render() {
          const checkbox = (React__default["default"].createElement("input", { type: "checkbox", checked: this.state.checked, onChange: this.change.bind(this), title: this.props.title }));
  ...
  class IngredientLine extends React__default["default"].Component {
      ...
      render() {
          ...
          return (React__default["default"].createElement("div", { className: classNames.join(' '), onClick: this.props.click },
              React__default["default"].createElement(ShopLink, { ingredientId: ingredId }),
              titleCaseFromUnderscored(ingredName),
              ':',
              React__default["default"].createElement(IngredientQuantity, { countOnHand: qtyOnHand, countPerCraft: qtyPerCraft }),
              max));
      }
  }
  ...
  class CraftingSubmenu extends React__default["default"].Component {
      ...
      render() {
          ...
          const ingredientCounts = new CountingSet();
          ...
          const maxWithPurchase = this.state.purchasable.length
              ? Math.min(...currentCraft.ingredients.map((ingredient) => this.state.purchasable.includes(ingredient.name)
          ...
          return (React__default["default"].createElement("div", { className: "crafting-panel", id: "crafting-submenu" },
              ...
              React__default["default"].createElement("div", { className: "crafting-panel-info__ingredients-column" }, currentCraft.ingredients.map((ingredient) => (React__default["default"].createElement(IngredientLine, { key: ingredient.id, click: () => {
                  ...
                  }, ingredient: ingredient, maxCraftableWithPurchase: maxWithPurchase, purchasable: this.state.purchasable.includes(ingredient.name), switchNeedHave: this.props.switchNeedHave })))),
              React__default["default"].createElement("span", { className: "crafting-panel-info__ingredients-max" },
                  "Max available craft(s): ",
                  currentCraft.available,
                  currentCraft.available !== maxWithPurchase ? (React__default["default"].createElement("span", { title: "Max possible if additional ingredients are purchased" },
                      "(",
                      maxWithPurchase,
                      ")")) : (''),
              ...
              currentCraft.available > 0 && (React__default["default"].createElement("div", { className: "crafting-panel-actions" },
                  React__default["default"].createElement("select", { className: "crafting-panel-actions__craft-number" }, Array(currentCraft.available)
                      .fill(undefined)
                  ...
                  React__default["default"].createElement(MaxCraftButton, { executeCraft: this.doCraft.bind(this), setMaxCraft: () => (document.querySelector('.crafting-panel-actions__craft-number').value = String(currentCraft.available)) })))));
      }
  }
  ...
  class QuickCrafter extends React__default["default"].Component {
      ...
      async setExtraSpace(extraSpace) {
      ...
      render() {
          return (React__default["default"].createElement(React__default["default"].StrictMode, null,
              React__default["default"].createElement(CraftingSubmenu, { inventory: this.props.inventory, recipe: recipes.find(({ itemId, name }) => name === this.state.currentCraft || ingredients[itemId].name === this.state.currentCraft), switchNeedHave: this.props.store.switchNeedHave }),
              ...
              React__default["default"].createElement("div", { className: "crafting-panel-actions__craft-row" },
                  ...
                  React__default["default"].createElement(Button, { variant: "click", classNameBase: "crafting-panel-filters__books-hide", clickCallback: () => {
                          BOOKS.forEach((book) => {
                              if (this.props.store.selectedBooks.includes(book)) {
                                  ReactTestUtils.Simulate.click(document.querySelector('.crafting-panel-filters__books-button--book-' + book.toLocaleLowerCase().replace(/ /g, '-')));
                              }
                          });
                      }, text: "Hide all" }),
                  React__default["default"].createElement(Button, { variant: "click", classNameBase: "crafting-panel-filters__books-show", clickCallback: () => {
                          BOOKS.forEach((book) => {
                              if (!this.props.store.selectedBooks.includes(book)) {
                                  ReactTestUtils.Simulate.click(document.querySelector('.crafting-panel-filters__books-button--book-' + book.toLocaleLowerCase().replace(/ /g, '-')));
                              }
                  ...
                  React__default["default"].createElement(Checkbox, { className: "quick_craft_button", checked: this.state.extraSpace, onChange: async (event) => {
                          if (event.target.checked) {
                              document.querySelector('.recipe-buttons').classList.add('recipe-buttons--extra-space');
                          }
                          else {
                              document
                                  .querySelector('.recipe-buttons')
                                  .classList.remove('recipe-buttons--extra-space');
                          }
                          await this.setExtraSpace(event.target.checked);
                      }, suffix: "Blank line between books" }),
                  React__default["default"].createElement(Checkbox, { title: "Switches between needed/have and have/needed", checked: this.props.store.switchNeedHave, onChange: (event) => {
                          Array.from(document.querySelectorAll('.crafting-panel-info__ingredient-row')).forEach((elem) => {
                              if (event.target.checked) {
              ...
              React__default["default"].createElement("div", { className: "crafting-panel-filters__books-row" }, BOOKS.map((name) => (React__default["default"].createElement(BookButton, { key: name, book: name, clickCallback: (selected) => {
              ...
              React__default["default"].createElement("div", { className: 'recipe-buttons recipe-buttons--book-sort' + (this.state.extraSpace ? ' recipe-buttons--extra-space' : '') }, BOOKS.map((bookName) => (React__default["default"].createElement("div", { key: bookName, className: 'recipe-buttons__book-section' +
                      (this.props.store.selectedBooks.includes(bookName) ? '' : ' recipe-buttons__book-section--disabled'), id: `recipe-buttons__book-section-${bookName.replace(/ /g, '_')}` }, recipes
                  .filter(({ book }) => book === bookName)
                  .map((recipe) => {
                  const name = recipe.name || ingredients[recipe.itemId].name;
                  return (React__default["default"].createElement(RecipeButton, { key: name, book: recipe.book, clickCallback: () => this.setCurrentCraft(name), name: name, selected: this.state.currentCraft === name }));
              }))))),
...
Please disable this userscript until you have one as this prompt will continue to show until you enter one in.`);
      ...
      createRoot(quickCrafter).render(React__default["default"].createElement(QuickCrafter, { extraSpace: await GM.getValue('SEG', false), inventory: INVENTORY, store: STORE }));
  })();
