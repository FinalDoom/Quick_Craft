...
(function (React, require$$0, lunr) {
  ...
  */
  ...
  class ShopLink extends React__default["default"].Component {
      constructor(props) {
          super(props);
          this.base = 'crafting-panel-info__ingredient-shop-link';
      }
      render() {
          return (React__default["default"].createElement("a", { className: this.base + (this.props.availableInStore ? ' ' + this.base + '--purchasable' : ''), target: "_blank", href: `https://gazellegames.net/shop.php?ItemID=${this.props.ingredientId}` }, this.props.availableInStore ? React__default["default"].createElement(HiCurrencyDollar, { size: "1rem" }) : React__default["default"].createElement(HiInformationCircle, { size: "1rem" })));
      }
  }
  ...
  class IngredientLine extends React__default["default"].Component {
      ...
      render() {
          ...
          return (React__default["default"].createElement("div", { className: classNames.join(' '), onClick: this.props.click },
              React__default["default"].createElement(ShopLink, { ingredientId: this.props.id, availableInStore: this.props.availableInStore }),
              this.props.name,
              ':',
  ...
  class CraftingSubmenu extends React__default["default"].Component {
      constructor(props) {
          super(props);
          this.craftNumberSelect = React__default["default"].createRef();
          this.maxCraftButton = React__default["default"].createRef();
      ...
      async doCraft() {
          ...
          try {
              ...
              if (this.maxCraftButton.current)
                  this.maxCraftButton.current.reset();
          }
      }
      render() {
          ...
          const maxWithPurchase = this.state.purchasable.length
              ? Math.min(...this.props.recipe.ingredients.map((ingredient) => this.state.purchasable.includes(ingredient.name)
                  ...
                  : Math.floor((this.props.inventory.get(ingredient.id) || 0) /
          ...
          return (React__default["default"].createElement("div", { className: "crafting-panel", id: "crafting-submenu" },
              ...
              React__default["default"].createElement("div", { className: "crafting-panel-info__ingredients-column" }, [...this.props.recipe.ingredientCounts.entries()].map(([id, count], index) => {
                  ...
                  return (React__default["default"].createElement(IngredientLine, { key: id, availableInStore: this.props.recipe.ingredients[index].infStock, click: () => {
              ...
              available > 0 && (React__default["default"].createElement("div", { className: "crafting-panel-actions" },
                  React__default["default"].createElement("select", { ref: this.craftNumberSelect, className: 'crafting-panel-actions__craft-number' + (this.state.isCrafting ? ' disabled' : '') }, Array(available)
                      .fill(undefined)
                      .map((_, i) => (React__default["default"].createElement("option", { key: i, value: i + 1 }, i + 1)))),
                  React__default["default"].createElement(Button, { variant: "click", additionalClassNames: this.state.isCrafting ? 'disabled' : '', classNameBase: "crafting-panel-actions__craft-button", clickCallback: this.doCraft.bind(this), text: "Craft" }),
                  React__default["default"].createElement(MaxCraftButton, { ref: this.maxCraftButton, executeCraft: this.doCraft.bind(this), setMaxCraft: () => this.craftNumberSelect.current && (this.craftNumberSelect.current.value = String(available)) })))));
      }
  }
  ...
  function Credits() {
      return (React__default["default"].createElement("div", { className: "credits" },
          React__default["default"].createElement("a", { target: "_blank", href: 'https://github.com/FinalDoom/Quick_Craft/' + 'releases/tag/v' + '3.4.4', className: "credits__version-link", title: 'Built on Sun, 27 Nov 2022 05:27:40 GMT' }, 'v' + '3.4.4'),
          React__default["default"].createElement("a", { target: "_blank", href: "https://github.com/FinalDoom/Quick_Craft/", className: "credits__github-link" },
  ...
  class QuickCrafter extends React__default["default"].Component {
      constructor(props) {
          super(props);
          this.craftingSubmenu = React__default["default"].createRef();
          this.state = {
      ...
      getFilteredRecipes(state) {
          ...
          const bookMatches = selectedBooks.size === 0
              ? []
              : recipeIndex
      ...
      render() {
          return (React__default["default"].createElement(React__default["default"].StrictMode, null,
              this.state.currentCraft !== undefined && (React__default["default"].createElement(CraftingSubmenu, { ref: this.craftingSubmenu, inventory: this.state.inventory, recipe: recipeInfo[this.state.currentCraft], switchNeedHave: this.state.switchNeedHave })),
