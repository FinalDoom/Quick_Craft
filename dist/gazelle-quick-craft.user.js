	...
	*/
	...
	function Credits() {
		return (React.createElement("div", { className: "credits" },
			React.createElement("a", { target: "_blank", href: 'github:FinalDoom/Quick_Craft.git' + 'releases/tag/v' + '3.5.2', className: "credits__version-link", title: 'Built on Tue, 31 Dec 2024 02:31:01 GMT' }, 'v' + '3.5.2'),
