...
// @downloadUrl https://github.com/FinalDoom/Quick_Craft/releases/latest/download/eligibility-checker.user.js
// @author      FinalDoom
// @license     ISC
// @grant       GM.getValue
// @grant       GM.setValue
...
(function (React, require$$0, lunr) {
	...
	*/
	...
	const recipeSearchIndex = lunr__default["default"](function () {
	    this.ref('id');
	...
	function Button(props) {
	    ...
	    return (React__default["default"].createElement("button", { ...htmlProps, className: clsx(classNameBase, additionalClassNames) }, text));
	}
	...
	function ToggleableButton(props) {
	    ...
	    return (React__default["default"].createElement(Button, { ...otherProps, additionalClassNames: clsx(additionalClassNames, props.classNameBase + (selected ? '--on' : '--off')), onClick: click }));
	}

	function BookButton(props) {
	    const base = 'crafting-panel-filters__books-button';
	    const { book, ...otherProps } = props;
	    return (React__default["default"].createElement(ToggleableButton, { ...otherProps, additionalClassNames: base + '--book-' + props.book.toLocaleLowerCase().replace(/ /g, '-'), classNameBase: base, text: props.book }));
	}
	...
	function MaxCraftButton(props) {
	    ...
	    return (React__default["default"].createElement(Button, { ...otherProps, additionalClassNames: clsx(additionalClassNames, state === ConfirmState.CONFIRM && base + '--confirm'), classNameBase: base, text: state.toString(), onClick: click }));
	}
	...
	function SelectableButton(props) {
	    ...
	    return (React__default["default"].createElement(Button, { ...otherProps, classNameBase: classNameBase, additionalClassNames: clsx(additionalClassNames, selected && classNameBase + '--selected') }));
	}

	function RecipeButton(props) {
	    const base = 'recipes__recipe';
	    return (React__default["default"].createElement(IsCraftingContext.Consumer, null, ({ isCrafting }) => (React__default["default"].createElement(SelectableButton, { ...props, disabled: isCrafting, additionalClassNames: base + '--book-' + props.book.toLocaleLowerCase().replace(/ /g, '-'), classNameBase: base, selected: props.selected, text: props.name }))));
	}
	...
	function Checkbox(props) {
	    ...
	    return (React__default["default"].createElement("label", { className: className },
	        prefix,
	        React__default["default"].createElement("input", { ...htmlProps, className: "", type: "checkbox" }),
	        suffix));
	}
	...
	function IngredientQuantity(propsIn) {
	    ...
	    return (React__default["default"].createElement("div", { className: clsx(base, props.switchNeedHave && base + '--swapped') },
	        React__default["default"].createElement("span", null, props.countOnHand),
	        "/",
	        React__default["default"].createElement("span", null, props.countPerCraft)));
	}
	...
	function ShopLink(props) {
	    ...
	    return (React__default["default"].createElement("a", { className: clsx(base, props.availableInStore && base + '--purchasable'), target: "_blank", href: `/shop.php?ItemID=${props.ingredientId}` }, props.availableInStore ? React__default["default"].createElement(HiCurrencyDollar, { size: "1rem" }) : React__default["default"].createElement(HiInformationCircle, { size: "1rem" })));
	}
	...
	function IngredientLine(props) {
	    ...
	    return (React__default["default"].createElement("div", { className: clsx(base + '-row', props.purchasable && base + '--purchasable'), onClick: props.click },
	        React__default["default"].createElement(ShopLink, { ingredientId: props.id, availableInStore: props.availableInStore }),
	        props.name,
	        ':',
	        React__default["default"].createElement(IngredientQuantity, { countOnHand: props.quantityAvailable, countPerCraft: props.quantityPerCraft, switchNeedHave: props.switchNeedHave }),
	        props.maxCraftableWithPurchase > props.quantityAvailable / props.quantityPerCraft && (React__default["default"].createElement("span", { title: "Needed for max possible crafts" },
	            ' (',
	...
	var CraftingSubmenu = (props) => {
	    ...
	    const maxWithPurchase = purchasable.length
	        ...
	        : available;
	    return (React__default["default"].createElement(IsCraftingContext.Consumer, null, ({ isCrafting, setIsCrafting }) => {
	        ...
	        return (React__default["default"].createElement("div", { className: "crafting-panel", id: "crafting-submenu" },
	            ...
	            React__default["default"].createElement("div", { className: "crafting-panel-info__ingredients-column" }, [...props.recipe.ingredientCounts.entries()].map(([id, count], index) => {
	                const name = props.recipe.ingredients[index].name;
	                return (React__default["default"].createElement(IngredientLine, { key: id, availableInStore: props.recipe.ingredients[index].infStock, click: () => {
	            ...
	            available > 0 && (React__default["default"].createElement("div", { className: "crafting-panel-actions" },
	                React__default["default"].createElement("select", { ref: craftNumberSelect, disabled: isCrafting, className: 'crafting-panel-actions__craft-number' }, Array(available)
	                    .fill(undefined)
	                    .map((_, i) => (React__default["default"].createElement("option", { key: i, value: i + 1 }, i + 1)))),
	                React__default["default"].createElement(Button, { disabled: isCrafting, classNameBase: "crafting-panel-actions__craft-button", onClick: wrappedDoCraft, text: "Craft" }),
	                React__default["default"].createElement(MaxCraftButton, { disabled: isCrafting, executeCraft: wrappedDoCraft, setMaxCraft: () => craftNumberSelect.current && (craftNumberSelect.current.value = String(available)) })))));
	    }));
	};
	...
	function Credits() {
	    return (React__default["default"].createElement("div", { className: "credits" },
	        React__default["default"].createElement("a", { target: "_blank", href: 'github:FinalDoom/Quick_Craft.git' + 'releases/tag/v' + '3.5.0', className: "credits__version-link", title: 'Built on Mon, 05 Dec 2022 03:38:55 GMT' }, 'v' + '3.5.0'),
	        React__default["default"].createElement("a", { target: "_blank", href: "github:FinalDoom/Quick_Craft.git", className: "credits__github-link" },
	            React__default["default"].createElement(FaGithub, null))));
	}
	...
	function SearchBox(searchProps) {
	    ...
	    let input = null;
	    return (React__default["default"].createElement("span", { className: base + '-wrapper' },
	        React__default["default"].createElement("input", { className: base, defaultValue: props.initialSearch, onChange: (event) => props.changeSearch(event.target.value), placeholder: props.placeholder, ref: (el) => (input = el), role: "search", type: "search" }),
	        React__default["default"].createElement("span", { role: "button", onClick: () => {
	                if (input) {
	                    input.value = '';
	                    input.focus();
	                }
	...
	function QuickCrafter(props) {
	    ...
	    const recipeButtons = recipeInfo.map((recipe) => (React__default["default"].createElement(RecipeButton, { key: recipe.id, book: recipe.book, onClick: () => setCurrentCraft(recipe.id), name: recipe.name, selected: currentCraft === recipe.id })));
	    return (React__default["default"].createElement(React__default["default"].StrictMode, null,
	        React__default["default"].createElement(IsCraftingContext.Provider, { value: { isCrafting, setIsCrafting } },
	            currentCraft !== undefined && ( // 0 is a valid currentCraft
	            React__default["default"].createElement(React__default["default"].Fragment, null,
	                React__default["default"].createElement(CraftingSubmenu, { inventory: inventory, recipe: recipeInfo[currentCraft], switchNeedHave: switchNeedHave }),
	                React__default["default"].createElement(Button, { disabled: isCrafting, classNameBase: "crafting-panel-actions__clear-craft-button", onClick: () => setCurrentCraft(undefined), text: "Clear" }))),
	            React__default["default"].createElement("div", { className: "crafting-panel-actions__craft-row" },
	                ...
	                React__default["default"].createElement(Button, { classNameBase: "crafting-panel-filters__books-hide", onClick: () => setSelectedBooks([]), text: "Hide all" }),
	                React__default["default"].createElement(Button, { classNameBase: "crafting-panel-filters__books-show", onClick: () => setSelectedBooks(BOOKS), text: "Show all" }),
	                React__default["default"].createElement(Checkbox, { checked: extraSpace, onChange: (event) => setExtraSpace(event.target.checked), suffix: "Blank line between books" }),
	                React__default["default"].createElement(Checkbox, { title: "Switches between needed/have and have/needed", checked: switchNeedHave, onChange: (event) => setSwitchNeedHave(event.target.checked), suffix: "NH switch" })),
	            React__default["default"].createElement("div", { className: "crafting-panel-filters__books-row" }, BOOKS.map((name) => (React__default["default"].createElement(BookButton, { key: name, book: name, selectedChanged: (nowSelected) => {
	            ...
	            React__default["default"].createElement("div", { className: "crafting-panel-search" },
	                React__default["default"].createElement(SearchBox, { changeSearch: setSearch, initialSearch: search }),
	                React__default["default"].createElement(Checkbox, { checked: searchIngredients, prefix: "Include ingredients", onChange: (event) => setSearchIngredients(event.target.checked) })),
	            React__default["default"].createElement("div", { className: clsx('recipe-buttons recipe-buttons--book-sort', extraSpace && 'recipe-buttons--extra-space') }, filteredRecipes.map((idOrArray) => {
	                if (Array.isArray(idOrArray)) {
	                    return (React__default["default"].createElement("div", { key: recipeInfo[idOrArray[0]].book, className: "recipe-buttons__book-section" }, idOrArray.map((id) => recipeButtons[id])));
	                }
	                else {
	                    return recipeButtons[idOrArray];
	                }
	            })),
	            React__default["default"].createElement(Credits, null))));
	}
...
Please disable this userscript until you have one as this prompt will continue to show until you enter one in.`);
	    ...
	    createRoot(quickCrafter).render(React__default["default"].createElement(QuickCrafter, { api: API }));
	})();
