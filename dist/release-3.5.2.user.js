...
(function (React, require$$0, lunr) {
	...
	*/
	...
	const useAsyncGMStorage = (key, defaultValue) => {
	    ...
	    const fetched = React__default["default"].useRef(false);
	...
	function Credits() {
	    return (React__default["default"].createElement("div", { className: "credits" },
	        React__default["default"].createElement("a", { target: "_blank", href: 'github:FinalDoom/Quick_Craft.git' + 'releases/tag/v' + '3.5.2', className: "credits__version-link", title: 'Built on Sun, 01 Jan 2023 08:35:59 GMT' }, 'v' + '3.5.2'),
