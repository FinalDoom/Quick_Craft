...
import Store, {QuickCraftStore, Storable} from './store/store';
...
class QuickCrafter extends React.Component<Props, State> {
...
Please disable this userscript until you have one as this prompt will continue to show until you enter one in.`);
  ...
  root.render(<QuickCrafter extraSpace={await GM.getValue('SEG', false)} inventory={INVENTORY} store={STORE} />);
})();
